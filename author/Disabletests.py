...
class AuthorTest(unittest.TestCase):
    print ('Hi from class AurthorTest')
    def create_app(self):
    ...
    def setUp(self):
        print ('Hi from class AurthorTest Setup')
        self.test_db = TestDB()
    ...
    def user_dict(self):
        print ('Hi from class AuthorTest user_dict')
        return dict(
    ...
    def test_user_register(self):
        print ('Hi from class AuthorTest test_user_register')
