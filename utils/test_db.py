...
class TestDB:
    ...
    def create_db(self):
        print('Hi from /utils/test_db.py create_db')
        print(f'self.db_uri = {self.db_uri}')
        print(f'self.db_root_password = {self.db_root_password}')
    ...
    def drop_db(self):
        print('Hi from /utils/test_db.py drop_db')
